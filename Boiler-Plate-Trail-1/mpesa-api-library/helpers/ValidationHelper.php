...
class ValidationHelper
{
    ...
    public static function normalizeMSISDN($msisdn)
    {
        ...
        $matchGroup = array();
        $isValid = preg_match('/^(\+|0)?(256)?((077|078)\d{7})$/', $msisdn, $matchGroup);
        ...
        if ($isValid) {
            ...
            $normalizedPhoneNumber = "256" . $matchedPhoneNumber;
            return $normalizedPhoneNumber;
        } else {
            throw new Exception("The provided number " . $msisdn . " is not valid MTN MSISDN.");
        }
    }
}